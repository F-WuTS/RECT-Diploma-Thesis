...
\def \year {2023/24}
\def \authors { \parseauthor{Themengebiet 1}{Jeremy Sztavinovszki}{5CHIF}\\
                \parseauthor{Themengebiet 2}{Christoph Fellner}{5BHIF}}
\def \supervisor { Harald Haberstroh }
\def \declauthors{ Jeremy Sztavinovszki, Christoph Fellner}	% for two authors
