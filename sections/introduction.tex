...
After the "Study of Literature" is the "Methods" section. This section covers the technologies and languages used, why they were chosen and seeks to provide a basic understanding of the 
technologies. Following that section is the
"Implementation" section, which covers the implementation details of each of the parts and explains design choices and tradeoffs taken. The last two sections are the
"Experiments" section and the "Conclusion" section. The "Experiments" section goes over the experiments performed for the thesis and their results. The "Conclusion" section
