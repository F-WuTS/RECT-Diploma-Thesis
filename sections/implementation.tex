...
basically the Rust Interface is responsible for the communication between the frontend and the backend of the RECT stack.\newline
...
use of remote procedure calls are also displayed in \ref{fig:rectcppClassUML}. All the classes with the \textit{Impl} ending are the implementations of the interfaces automatically
