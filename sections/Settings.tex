...
\lstdefinelanguage{CMake}{
	morecomment=[l]{#},
	morestring=[b]{"},
	morekeywords=[1]{cmake_minimum_required, project, set, file, find_package, add_library, target_link_libraries, target_include_directories, get_target_property, target_compile_definitions},
	morekeywords=[2]{CMAKE_CURRENT_BINARY_DIR, \$}
	
}

\lstdefinestyle{CMakeColour} {
	basicstyle=\ttfamily, 
	identifierstyle=,
	commentstyle=\color[gray]{0.4},
	stringstyle=\color[rgb]{0, 0, 0.5},
...
\lstdefinelanguage{ProtoBuf}{
	...
	morekeywords=[2]{string, rpc, field_type, bytes},
}

\lstdefinestyle{ProtoBufColour} {
	basicstyle=\ttfamily, 
	identifierstyle=,
	commentstyle=\color[gray]{0.4},
	stringstyle=\color[rgb]{0, 0, 0.5},
