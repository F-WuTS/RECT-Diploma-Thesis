...
\begin{figure}
	\centering
	\includegraphics[scale=1]{doxygenStructure.png}
	\caption{Doxygen structure diagramm form Doxygen documentation}
	\label{pic:doxygen_structure}
\end{figure}
...
\verbatim{doxygen <config-file>}

Doxygen normally requires the source code to be annotated in order to generate documentation, but a rough version can be made by setting the tag EXTRACT_ALL to YES.
